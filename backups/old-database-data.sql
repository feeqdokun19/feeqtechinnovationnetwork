...
COPY public."User" (id, name, email, password, phone, role, "createdAt", "updatedAt", "verificationStatus", "verifiedAt") FROM stdin;
...
COPY public."Service" (id, title, description, price, category, status, "providerId", "createdAt", "updatedAt") FROM stdin;
...
COPY public."Order" (id, "customerId", "serviceId", amount, status, notes, "createdAt", "updatedAt", "customerApproved", "customerApprovedAt", "providerApproved", "providerApprovedAt", "providerAccepted", "providerAcceptedAt", "providerDeclineReason", "providerDeclinedAt", "closedAt", "completedAt", "paidAt", "scheduledAt", "startedAt") FROM stdin;
...
COPY public."Notification" (id, "userId", "orderId", type, title, message, "isRead", "createdAt", "updatedAt") FROM stdin;
...
COPY public."OrderEvent" (id, "orderId", type, message, "createdAt") FROM stdin;
...
COPY public."Review" (id, rating, comment, "userId", "serviceId", "createdAt", "orderId") FROM stdin;
...
COPY public."Transaction" (id, amount, "customerId", "serviceId", "createdAt", "updatedAt", "orderId", status, "paidAt", "paymentProvider", "paymentReference") FROM stdin;
...
COPY public."VerificationRequest" (id, "userId", status, "submittedAt", "reviewedAt", "rejectionReason", "createdAt", "updatedAt") FROM stdin;
\.
